...
def parse_args():
    ...
    parser.add_argument('--pretrain', type=str, default='/opt/ml/result/mod_segformer/checkpoint298.pth')
    parser.add_argument('--save_path', type=str, default='/opt/ml/result/mod_segformer_ft/')
