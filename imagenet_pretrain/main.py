...
sys.path.append('/opt/ml/input/nota/')
...
def get_args_parser():
    ...
    # Model parameters
    parser.add_argument('--model', default='segformer', type=str, metavar='MODEL',
                        help='Name of model to train')
    parser.add_argument('--model_name', default='origin', type=str)
